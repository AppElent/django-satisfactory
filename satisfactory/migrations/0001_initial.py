...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='recipe',
            name='ingredients',
            field=models.ManyToManyField(related_name='recipe_input', through='satisfactory.RecipeInput', to='satisfactory.Product'),
        ),
        migrations.AddField(
            model_name='recipe',
            name='machine',
        ...
        migrations.AddField(
            model_name='recipe',
            name='products',
            field=models.ManyToManyField(related_name='recipe_output', through='satisfactory.RecipeOutput', to='satisfactory.Product'),
        ),
        migrations.AddField(
            model_name='product',
            name='default_recipe',
        ...
        migrations.CreateModel(
            name='BuildableIngredient',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.IntegerField(default=1)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('buildable', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='satisfactory.buildable')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='satisfactory.product')),
            ],
        ),
        migrations.AddField(
            ...
            name='ingredients',
            field=models.ManyToManyField(related_name='buildables', through='satisfactory.BuildableIngredient', to='satisfactory.Product'),
        ),
